...
app.put("/update", async (req: any, res: any) => {
  ...
  while (user.length > index) {
    if (!user) return;
    user[index].fcmToken =
      "cc_NhIGbTBmemZMw8r2zCg:APA91bHVlC1hFJTwIpYIdy5i8NDeg5CDROyjMCZ-VWzGEnwkia680_a2phWpSEz22anmMDZhlDj6vLEPm4lyjXWY19CNRmsa-DCvlB9zXFvAyZ_ENkoctgjtNui9k49w7dfgwoimaNJ_";
